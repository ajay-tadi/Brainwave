...
import CompayLogo from "../design/CompayLogo";
  ...
  return (
    ...
    >
      <div className="container relative" ref={parallaxRef}>
        ...
        mx-auto text-center mb-[4rem] md:mb-20 lg:mb-[6.25rem]"
        >
        ...
        <div className="relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24">
          <div className="relative z-1 rounded-xl p-0.5 bg-conic-gradient">
        ...
        <CompayLogo className="hidden relative z-10 mt-20 lg:block" />
      </div>
